...
export default function IAStatistics({ students }) {
  ...
  const stats = [
    ...
    { label: 'Class Avg', value: classAverage, color: Colors.purple },
  ];
...
const styles = StyleSheet.create({
  ...
  card: {
    width: '23%',
    backgroundColor: Colors.white, borderRadius: 12, padding: 12, alignItems: 'center',
