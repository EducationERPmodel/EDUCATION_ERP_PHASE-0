...
export default function IAMarksTable({ students, onEdit, onDelete }) {
  return (
...
const styles = StyleSheet.create({
  ...
  headerRow: {
    backgroundColor: Colors.primaryLight, borderRadius: 8, borderBottomWidth: 0, paddingVertical: 10,
  },
